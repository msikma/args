...
const langEng = {
  ...
  assets: langOpts => ({
    ...
    errorInvalidValueOption: ({ argInput, argRef, invalidValues, acceptedValues }) => `Argument ${argInput.originalValue}: value must be one of {${genericAssets.joinArgs(acceptedValues)}}: ${invalidValues.map(value => value.originalValue)}`,
